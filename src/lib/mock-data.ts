...
export const quantities: QuantityItem[] = [
  {
    ...
    unit: "m3",
    totalQuantity: 520,
    completedQuantity: 238,
    plannedFinishDate: "2026-06-10",
    workArea: "地下室 B 区",
    category: "混凝土",
    owner: "林施工",
    status: "in_progress",
    remark: "按浇筑小票和施工日志同步核对。",
    createdAt: "2026-05-30 09:00",
    updatedAt: "2026-05-31 18:20",
  },
  {
    id: "qty-002",
    projectId: project.id,
    ...
    unit: "吨",
    totalQuantity: 22,
    completedQuantity: 18.6,
    plannedFinishDate: "2026-06-05",
    workArea: "塔楼 A 8 层",
    category: "钢筋",
    owner: "吴技术",
    status: "delayed",
    remark: "受机电预留复核影响，需跟踪剩余绑扎量。",
    createdAt: "2026-05-29 10:00",
    updatedAt: "2026-05-31 17:00",
  },
  {
    id: "qty-003",
    projectId: project.id,
...
export const quantityUpdates: QuantityUpdate[] = [
  {
    id: "qu-001",
    quantityId: "qty-001",
    projectId: project.id,
    ...
    submittedBy: "林施工",
    description: "完成地下室 B 区顶板第一仓浇筑，方量按商砼小票汇总。",
    delayReason: "",
    attachments: [],
  },
  {
    ...
    quantityId: "qty-002",
    projectId: project.id,
    completedAmount: 18.6,
    updatedAt: "2026-05-31",
    submittedBy: "吴技术",
    description: "墙柱钢筋绑扎完成约 85%，剩余洞口加强筋待复核。",
    delayReason: "机电预留洞口复核占用作业面。",
    attachments: [],
  },
];
